...
- Bitango operates a test mint (mint.minibits.cash) for research and evaluation purposes only. It's use is optional and not a prerequisity for wallet functionality. See Part 2 for the specific terms governing that mint.
