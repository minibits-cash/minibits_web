...
**Bitango Technologies** Bratislava, Slovak Republic (reg. no. 51 299 631)
...
All other related Minibits services (Minibits Test mint, Minibits Recovery Tool and Minibits Ippon hosted instance) are experimental intended only for development and testing. They are operated by physical persons working voluntarily on the Minibits project ("Development team"), NOT by the Bitango Technologies, company providing the Wallet. Wallet functionality does not strictly depend on any of those services.
...
>
> The services are made available solely to advance research into peer-to-peer electronic cash systems. Bitango and the Development team makes no representation that any service is fit for any purpose beyond research and evaluation.
