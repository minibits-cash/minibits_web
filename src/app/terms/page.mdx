...
Bitango Technologies, a private limited company, develops the Minibits Wallet ("Wallet"), an open-source mobile app supporting Bitcoin-backed ecash, the Cashu protocol, and the Lightning Network. The project is self-funded from company's own capital and from voluntary donations.

All other related Minibits services (Minibits Test mint, Minibits Recovery Tool and Minibits Ippon hosted instance) are experimental and intended only for development and testing. They are operated by physical persons working voluntarily on the Minibits project ("Development team"), NOT by the Bitango Technologies, company providing the Wallet. Wallet functionality does not strictly depend on any of those services.
...
>
> The services are made available solely to advance research into peer-to-peer electronic cash systems. Bitango and the Development team makes no representation that any service is fit for any purpose beyond research and development.
...
Bitango does not operate any user accounts holding balances. Ecash notes are solely self-hosted in your wallet's device storage at your own risk and initiative. You are responsible for complying with all tax and reporting obligations arising from your use.
...
As a part of the Wallet infrastructure, Bitango operates a public LNURL/NOSTR server that enables wallet addresses (e.g. yourname@minibits.cash) to function as Lightning addresses and NOSTR NIP-05 identifiers. By using this feature you acknowledge:
...
The Development team operates voluntarily and on best-effort basis an experimental Cashu mint ("Test Mint"). Only supported ecash unit is SAT ("satoshi"). The Test Mint is solely development and test intended deployment used to test interoperability with other Cashu protocol implementations, and to develop and test the Minibits Wallet.

The Minibits Recovery Tool is a companion web application that assists developers and testers in recovering ecash tokens from the Test Mint in situations where the Wallet is unable to do so automatically.

### 2.2 Strictly for Development and Testing

> **TEST MINT — CRITICAL LIMITATIONS**
>
> The Test Mint is operated exclusively for development and testing purposes. Mint reserves are held by the Bitcoin Lightning node. There is no guarantee whatsoever that Bitcoin Lightning node will not fail or lose its reserves as a result of technical failure, operational error, theft or force majeure.
>
> **DO NOT store funds in the Test Mint that you cannot afford to lose entirely.**

Access to the Test Mint is open to any Cashu-compatible wallet for development and testing purposes only. The Test Mint imposes strict limits on transaction amounts, published at mint's /info endpoint.

### 2.3 No Uptime Guarantee

The Test Mint is operated voluntarily, on a best-efforts basis, by physical persons participating in the project's development team. Those persons makes no commitment regarding availability, uptime, or the duration for which the mint will remain operational. The Test Mint may be taken offline, reset, or permanently discontinued at any time without prior notice.
...
Minibits Ippon ("Ippon") is an experimental, open-source ecash and Lightning wallet implementation designed primarily for non-human systems — in particular AI agents and automated processes — that require programmatic access to micropayment capabilities. Ippon is available as:
...
Ippon is released as open-source software under the MIT Licence. The hosted instance at ippon.minibits.cash is operated by the Development team and serves for development and testing purposes only.
...
- Emptying your wallets at the conclusion of each agentic session. Ippon wallets are designed to be short-lived and should not hold balances over the long term.
...
The hosted instance at ippon.minibits.cash enforces strict limits on wallet balances, payment amounts, and wallet creation rates. These limits are published via the GET /v1/info endpoint. Bitango reserves the right to change these limits at any time without notice.
...
The hosted instance at ippon.minibits.cash is operated by the Development team on a best-efforts basis, only for development and testing purposes. Development team makes no commitment regarding uptime, availability, or continuity of service. The instance may be reset or discontinued at any time.

---

## Entire Agreement

These Terms, together with the Privacy Policy at [https://minibits.cash/privacy](https://minibits.cash/privacy), constitute the entire agreement between you and Bitango Technologies, s.r.o. in relation to the Minibits Wallet and between you and the Development team in relation to the related Minibits services and supersede all prior representations, agreements, or understandings.
